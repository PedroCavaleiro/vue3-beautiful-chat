<template>
  <div class="sc-header" :style="{background: colors.header.bg, color: colors.header.text}">
    ...
    <div v-if="showMinimizeButton" class="sc-header--minimize-button" @click="$emit('minimize')">
      ...
      <svg v-else xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 47.971 47.971"><g><rect x="0" y="20" width="47.971" height="7.971" rx="3" ry="3"/></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
    </div>
    <div v-if="showCloseButton" class="sc-header--close-button" @click="$emit('close')">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 47.971 47.971"><g><path d="M28.228,23.986L47.092,5.122c1.172-1.171,1.172-3.071,0-4.242c-1.172-1.172-3.07-1.172-4.242,0L23.986,19.744L5.121,0.88
...
.sc-header--close-button img, .sc-header--close-button svg {
  width: 100%;
  height: 100%;
  padding: 13px;
  box-sizing: border-box;
...
.sc-header--minimize-button img, .sc-header--minimize-button svg {
  width: 100%;
  height: 100%;
  padding: 13px;
  box-sizing: border-box;

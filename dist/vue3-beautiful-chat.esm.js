...
function t3(D, u) {
  ...
  function H(i, s) {
    s === "." ? i.state = 7 : s === "-" ? i.state = 6 : s === ":" ? i.state = 8 : PD(s) ? i.state = 10 : $D(s) || L(i);
  }
  function I(i, s) {
  ...
  function uu(i, s) {
    s === "." ? i.state = 14 : s === ":" ? i.state = 8 : Z.test(s) || (PD(s) ? i.state = 10 : Su.test(s) ? P(d, i) : L(i));
  }
  function G(i, s) {
  ...
  function Mu(i, s) {
    s === "." ? i.state = 27 : s === "-" ? i.state = 26 : $D(s) || L(i);
  }
  function mu(i, s) {
    s === "-" || s === "." ? L(i) : $D(s) ? i.state = 25 : L(i);
  }
  function Hu(i, s) {
  ...
  function h1(i, s) {
    zD(s) ? i.state = 40 : Z.test(s) ? P(d, i) : L(i);
  }
  function L(i) {
...
const ne = /* @__PURE__ */ M(fe, [["render", Fe], ["__scopeId", "data-v-88c66c15"]]), ae = {
  components: {
    EmojiPicker: ne
  },
  props: {
...
}, de = { class: "sc-user-input--picker-wrapper" }, re = ["color"];
...
const oe = /* @__PURE__ */ M(ae, [["render", ie], ["__scopeId", "data-v-967f979e"]]), se = {
  props: {
    onChange: {
      type: Function,
      required: !0

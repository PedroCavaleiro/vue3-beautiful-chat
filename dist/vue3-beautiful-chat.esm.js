import { reactive as A1, openBlock as b, createElementBlock as m, normalizeStyle as j, createCommentVNode as R, renderSlot as O, createTextVNode as Nu, toDisplayString as K, createElementVNode as y, resolveComponent as T, createVNode as q, withCtx as $, resolveDirective as y1, normalizeClass as DD, withDirectives as qf, createBlock as V, Fragment as qu, renderList as Qu, vShow as w1, withModifiers as Gu, pushScopeId as k1, popScopeId as x1, nextTick as S1, withScopeId as T1, withKeys as O1, mergeProps as Rf, createApp as $1, h as j1 } from "vue";
const Du = {
  state: A1({
    editMessage: null
  }),
...
function Q3(D, u, f, e, F, t) {
  ...
  return b(), m("div", {
    ...
    (b(!0), m(qu, null, Qu(f.messages, (a, r) => (b(), V(n, {
      key: a.id ? a.id : r,
      message: a,
...
function ne(D, u, f, e, F, t) {
  return b(), m("div", {
    ...
    y("div", ee, [
      (b(!0), m(qu, null, Qu(F.emojiData, (n) => (b(), m("div", {
        key: n.name,
        class: "sc-emoji-picker--category"
      }, [
        y("div", te, K(n.name), 1),
        (b(!0), m(qu, null, Qu(n.emojis, (a) => (b(), m("span", {
          key: a,
...
}, re = { class: "sc-user-input--picker-wrapper" };
function ie(D, u, f, e, F, t) {
...
const oe = /* @__PURE__ */ M(de, [["render", ie], ["__scopeId", "data-v-007d3979"]]), se = {
  props: {
    onChange: {
      type: Function,
      required: !0
...
const Be = /* @__PURE__ */ M(se, [["render", le], ["__scopeId", "data-v-1c07555d"]]), be = {
  components: {
    IconBase: Mf
  },
  props: {
...
function ve(D, u, f, e, F, t) {
  return b(), m("div", {
    ...
    (b(!0), m(qu, null, Qu(f.suggestions, (n, a) => (b(), m("button", {
      key: a,
...
function Je(D, u, f, e, F, t) {
  return b(), m("div", {
    ...
    y("table", Ye, [
      y("tbody", null, [
        (b(!0), m(qu, null, Qu(f.participants, (n) => (b(), m("tr", {
          key: n.id
        }, [
          y("td", Qe, [
            y("img", {
...
var eu = "top", ou = "bottom", su = "right", tu = "left", AD = "auto", tD = [eu, ou, su, tu], Ru = "start", Df = "end", o2 = "clippingParents", Qf = "viewport", Wu = "popper", s2 = "reference", pf = /* @__PURE__ */ tD.reduce(function(D, u) {
...
function W2(D) {
  ...
  if (!u.modifiersData[e]._skip) {
    for (var F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !0 : n, r = f.fallbackPlacements, C = f.padding, d = f.boundary, c = f.rootBoundary, o = f.altBoundary, B = f.flipVariations, E = B === void 0 ? !0 : B, A = f.allowedAutoPlacements, h = u.options.placement, w = ru(h), _ = w === h, v = r || (_ || !E ? [hD(h)] : V2(h)), p = [h].concat(v).reduce(function(Q, l) {
      ...
      var U = p[z], uu = ru(U), G = Zu(U) === Ru, nu = [eu, ou].indexOf(uu) >= 0, gu = nu ? "width" : "height", Eu = uD(u, {
        placement: U,
        boundary: d,
        rootBoundary: c,
        altBoundary: o,
...
function f8(D) {
  ...
  if (k) {
    if (t || a) {
      var U = p === "y" ? eu : tu, uu = p === "y" ? ou : su, G = p === "y" ? "height" : "width", nu = k[p], gu = k[p] + h[U], Eu = k[p] - h[uu], au = B ? -S[G] / 2 : 0, yu = _ === Ru ? x[G] : S[G], W = _ === Ru ? -S[G] : -x[G], Y = u.elements.arrow, J = B && Y ? ff(Y) : {
        width: 0,
        height: 0
  ...
  return b(), V(
    ...
    [q("div", O8, [q(
      ...
      [f.mounted ? (b(), V(
        ...
        [q("div", null, [O(D.$slots, "default")]), f.handleResize ? (b(), V(n, {
          key: 0,

import { reactive as y1, openBlock as p, createElementBlock as m, normalizeStyle as I, createCommentVNode as z, renderSlot as x, createTextVNode as Nu, toDisplayString as Z, createElementVNode as b, resolveComponent as $, createVNode as L, withCtx as T, resolveDirective as w1, normalizeClass as DD, withDirectives as qf, createBlock as V, Fragment as qu, renderList as Ku, vShow as k1, withModifiers as Gu, pushScopeId as x1, popScopeId as S1, nextTick as T1, withScopeId as O1, withKeys as $1, mergeProps as Lf, createApp as j1, h as P1 } from "vue";
const Du = {
  state: y1({
    editMessage: null
  }),
...
function i0(D, u, f) {
  ...
  var t = function(v) {
    ...
    var g = A / 2, h = Math.ceil(g), k = -1 * Math.floor(g), S = "";
    return k < 0 && (S = v.substr(k)), v.substr(0, h) + f + S;
  };
  if (D.length <= u)
    return D;
  var r = u - F, s = t(D);
  if (s.query) {
    ...
    d && (s.query = s.query.substr(0, d[1].length), D = n(s));
  }
  if (D.length <= u || (s.host && (s.host = s.host.replace(/^www\./, ""), D = n(s)), D.length <= u))
    return D;
  var c = "";
  if (s.host && (c += s.host), c.length >= r)
    return s.host.length == u ? (s.host.substr(0, u - F) + f).substr(0, r + e) : a(c, r).substr(0, r + e);
  var o = "";
...
function e3(D, u) {
  for (var f = u.tagBuilder, e = u.stripPrefix, F = u.stripTrailingSlash, t = u.decodePercentEncoding, n = u.hashtagServiceName, a = u.mentionServiceName, r = [], s = D.length, d = [], c = 0; c < s; c++) {
    var o = D.charAt(c);
    if (d.length === 0)
      w(o);
    else {
  ...
  function uu(i, C) {
    C === "." ? i.state = 14 : C === ":" ? i.state = 8 : J.test(C) || (PD(C) ? i.state = 10 : Su.test(C) ? P(d, i) : R(i));
  }
  function G(i, C) {
  ...
  function Bu(i, C) {
    ID(C) ? i.state = 22 : P(d, i);
  }
  function K(i, C) {
    C === "." ? i.state = 23 : C === "@" ? i.state = 24 : ID(C) ? i.state = 22 : P(d, i);
  }
  function l(i, C) {
    C === "." || C === "@" ? P(d, i) : ID(C) ? i.state = 22 : P(d, i);
  }
  function Ou(i, C) {
  ...
  function R(i) {
    if (P(d, i), !!i.acceptStateReached) {
      var C = i.startIdx, j = D.slice(i.startIdx, c);
      if (j = F3(j), i.type === "url") {
        ...
        if (Uu === "scheme") {
          var OD = Gf.exec(j);
          if (OD && (C = C + OD.index, j = j.slice(OD.index)), !_0(j))
            return;
        } else if (Uu === "tld") {
          if (!v0(j))
            return;
...
function o3(D, u) {
  for (var f = u.onOpenTag, e = u.onCloseTag, F = u.onText, t = u.onComment, n = u.onDoctype, a = new pu(), r = 0, s = D.length, d = 0, c = 0, o = a; r < s; ) {
    var B = D.charAt(r);
    switch (d) {
      case 0:
        E(B);
...
function B3() {
  ...
  return LD = (t, n = D) => {
    ...
    for (; r < t.length; ) {
      const o = t[r];
      o === n.bold.delimiter ? c(n.bold) : o === n.italic.delimiter ? c(n.italic) : o === n.underline.delimiter ? c(n.underline) : o === n.strike.delimiter ? c(n.strike) : o === n.code.delimiter ? c(n.code) : o === n.sup.delimiter ? c(n.sup) : o === n.sub.delimiter ? c(n.sub) : s();
    }
    return a;
  }, LD;
}
...
function A3(D, u, f, e, F, t) {
  const n = $("IconEdit"), a = $("IconBase"), r = $("IconCross");
  return p(), m("div", {
    ...
    b("div", {
      ...
      x(D.$slots, "text-message-toolbox", {
        message: f.message,
        me: t.me
      }, void 0, !0)
    ], 4),
    ...
    return [
      b("div", {
        ...
        b("div", {
          ...
          b("a", {
            href: (a = f.message.data.file) != null && a.url ? (r = f.message.data.file) == null ? void 0 : r.url : "#",
            target: "_blank"
          }, Z(((s = f.message.data.file) == null ? void 0 : s.name) || ""), 9, S3)
        ], 4),
        b("div", {
...
const O3 = /* @__PURE__ */ M(w3, [["render", T3], ["__scopeId", "data-v-0eb14ee3"]]), $3 = {
  props: {
    data: {
      type: Object,
      required: !0
...
function R3(D, u, f, e, F, t) {
  return p(), m("div", {
    ...
    x(D.$slots, "default", { message: f.data }, () => [
      Nu(Z(f.data.text) + " ", 1),
      f.data.meta ? (p(), m("p", {
        key: 0,
        class: "sc-message--meta",
...
function W3(D, u, f, e, F, t) {
  const n = $("TextMessage"), a = $("EmojiMessage"), r = $("FileMessage"), s = $("TypingMessage"), d = $("SystemMessage"), c = w1("tooltip");
  return p(), m("div", {
    id: f.message.id,
    class: "sc-message",
    style: I({
...
function X3(D, u, f, e, F, t) {
  ...
  return p(), m("div", {
    ...
    (p(!0), m(qu, null, Ku(f.messages, (a, r) => (p(), V(n, {
      ...
      "system-message-body": T((s) => [
        x(D.$slots, "system-message-body", {
          message: s.message
        }, void 0, !0)
      ]),
      "text-message-toolbox": T((s) => [
        x(D.$slots, "text-message-toolbox", {
          message: s.message,
          me: s.me
        }, void 0, !0)
  ...
  return pf || (pf = 1, function(D, u) {
    (function() {
      ...
      F.prototype.noConflict = function() {
        ...
        var n = this;
        n.init_emoticons();
        var a = 0, r = [], s = t.replace(n.rx_emoticons, function(o, B, E, y) {
          var _ = a;
          a = y + o.length;
...
8)`) {
        ...
        return n.init_colons(), t.replace(n.rx_colons, function(a) {
          ...
          if (n.allow_caps && (r = r.toLowerCase()), r.indexOf("::skin-tone-") > -1) {
            var s = r.substr(-1, 1), d = "skin-tone-" + s, c = n.map.colons[d];
        ...
        var n = this;
        return n.init_unified(), t.replace(n.rx_unified, function(a, r, s) {
          var d = n.map.unified[r];
          if (d) {
            var c = null;
            return s == "🏻" && (c = "1f3fb"), s == "🏼" && (c = "1f3fc"), s == "🏽" && (c = "1f3fd"), s == "🏾" && (c = "1f3fe"), s == "🏿" && (c = "1f3ff"), c ? n.replacement(d, null, null, {
              idx: c,
              actual: s,
              wrapper: ""
            }) : n.replacement(d);
        ...
        for (var n = this, a = 0; a < t.length; a++) {
          ...
          u:
            for (var s in n.data)
              for (var d = 0; d < n.data[s][3].length; d++)
                if (r == n.data[s][3][d]) {
                  n.map.colons[r] = s;
                  break u;
                }
        }
      }, F.prototype.replacement = function(t, n, a, r, s) {
        var d = this, c = "", o = null;
        ...
        if (!t.inits.unified) {
          ...
          for (var a in t.variations_data)
            if (!(t.variations_data[a]["1f3fb"] && t.variations_data[a]["1f3fb"][0] == a + "-1f3fb"))
              for (var s in t.variations_data[a])
                for (var r = 0; r < t.variations_data[a][s][4].length; r++)
                  n.push(t.variations_data[a][s][4][r].replace("*", "\\*")), t.map.unified_vars[t.variations_data[a][s][4][r]] = [a, s];
...
function Ue(D, u, f, e, F, t) {
  const n = $("Suggestions"), a = $("EmojiIcon"), r = $("FileIcons"), s = $("IconCross"), d = $("UserInputButton"), c = $("IconOk"), o = $("IconSend");
  return p(), m("div", null, [
    L(n, {
...
function Je(D, u, f, e, F, t) {
  const n = $("Header"), a = $("UserList"), r = $("MessageList"), s = $("UserInput");
  return p(), m("div", {
    ...
    F.showUserList ? z("", !0) : (p(), V(r, {
      ...
      "system-message-body": T((d) => [
        x(D.$slots, "system-message-body", {
          message: d.message
        }, void 0, !0)
      ]),
      "text-message-toolbox": T((d) => [
        x(D.$slots, "text-message-toolbox", {
          message: d.message,
          me: d.me
        }, void 0, !0)
...
function n2(D, u, f, e, F, t) {
  ...
  return p(), m("div", null, [
    ...
    L(n, {
      ...
      "system-message-body": T((a) => [
        x(D.$slots, "system-message-body", {
          message: a.message
        }, void 0, !0)
      ]),
      "text-message-toolbox": T((a) => [
        x(D.$slots, "text-message-toolbox", {
          message: a.message,
          me: a.me
        }, void 0, !0)
...
const a2 = /* @__PURE__ */ M(f2, [["render", n2], ["__scopeId", "data-v-a61d7f5e"]]);
...
function g2(D) {
  ...
  return Object.assign(u.elements.popper.style, f.popper), u.styles = f, u.elements.arrow && Object.assign(u.elements.arrow.style, f.arrow), function() {
    Object.keys(u.elements).forEach(function(e) {
      var F = u.elements[e], t = u.attributes[e] || {}, n = Object.keys(u.styles.hasOwnProperty(e) ? u.styles[e] : f[e]), a = n.reduce(function(r, s) {
        return r[s] = "", r;
      }, {});
...
function A2(D) {
  var u, f = D.state, e = D.name, F = D.options, t = f.elements.arrow, n = f.modifiersData.popperOffsets, a = ru(f.placement), r = ef(a), s = [tu, su].indexOf(a) >= 0, d = s ? "height" : "width";
  if (!(!t || !n)) {
    var c = v2(F.padding, f), o = ff(t), B = r === "y" ? eu : tu, E = r === "y" ? ou : su, y = f.rects.reference[d] + f.rects.reference[r] - n[r] - f.rects.popper[d], _ = n[r] - f.rects.reference[r], w = FD(t), v = w ? r === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, A = y / 2 - _ / 2, g = c[B], h = v - o[d] - c[E], k = v / 2 - o[d] / 2 + A, S = mD(g, k, h), O = r;
    f.modifiersData[e] = (u = {}, u[O] = S, u.centerOffset = S - k, u);
  }
}
function y2(D) {
...
function mf(D) {
  var u, f = D.popper, e = D.popperRect, F = D.placement, t = D.offsets, n = D.position, a = D.gpuAcceleration, r = D.adaptive, s = D.roundOffsets, d = s === !0 ? x2(t) : typeof s == "function" ? s(t) : t, c = d.x, o = c === void 0 ? 0 : c, B = d.y, E = B === void 0 ? 0 : B, y = t.hasOwnProperty("x"), _ = t.hasOwnProperty("y"), w = tu, v = eu, A = window;
  if (r) {
  ...
  if (a) {
    var O;
    return Object.assign({}, S, (O = {}, O[v] = _ ? "0" : "", O[w] = y ? "0" : "", O.transform = (A.devicePixelRatio || 1) < 2 ? "translate(" + o + "px, " + E + "px)" : "translate3d(" + o + "px, " + E + "px, 0)", O));
  }
  return Object.assign({}, S, (u = {}, u[v] = _ ? E + "px" : "", u[w] = y ? o + "px" : "", u.transform = "", u));
}
function S2(D) {
...
function O2(D) {
  var u = D.state, f = D.instance, e = D.options, F = e.scroll, t = F === void 0 ? !0 : F, n = e.resize, a = n === void 0 ? !0 : n, r = cu(u.elements.popper), s = [].concat(u.scrollParents.reference, u.scrollParents.popper);
...
function L2(D, u, f) {
  var e = u === "clippingParents" ? q2(D) : [].concat(u), F = [].concat(e, [f]), t = F[0], n = F.reduce(function(a, r) {
    var s = _f(D, r);
    return a.top = vu(s.top, a.top), a.right = Qu(s.right, a.right), a.bottom = Qu(s.bottom, a.bottom), a.left = vu(s.left, a.left), a;
  }, _f(D, t));
...
function uD(D, u) {
  u === void 0 && (u = {});
  var f = u, e = f.placement, F = e === void 0 ? D.placement : e, t = f.boundary, n = t === void 0 ? d2 : t, a = f.rootBoundary, r = a === void 0 ? Zf : a, s = f.elementContext, d = s === void 0 ? Wu : s, c = f.altBoundary, o = c === void 0 ? !1 : c, B = f.padding, E = B === void 0 ? 0 : B, y = D1(typeof E != "number" ? E : f1(E, tD)), _ = d === Wu ? r2 : Wu, w = D.elements.reference, v = D.rects.popper, A = D.elements[o ? _ : d], g = L2(Zu(A) ? A : A.contextElement || Au(D.elements.popper), n, r), h = Ru(w), k = t1({
    reference: h,
    element: v,
    strategy: "absolute",
    placement: F
  }), S = VD(Object.assign({}, v, k)), O = d === Wu ? S : h, H = {
    top: g.top - O.top + y.top,
    bottom: O.bottom - g.bottom + y.bottom,
    left: g.left - O.left + y.left,
    right: O.right - g.right + y.right
...
function R2(D, u) {
  u === void 0 && (u = {});
  var f = u, e = f.placement, F = f.boundary, t = f.rootBoundary, n = f.padding, a = f.flipVariations, r = f.allowedAutoPlacements, s = r === void 0 ? yD : r, d = Ju(e), c = d ? a ? bf : bf.filter(function(E) {
    return Ju(E) === d;
...
function H2(D) {
  ...
  if (!u.modifiersData[e]._skip) {
    for (var F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !0 : n, r = f.fallbackPlacements, s = f.padding, d = f.boundary, c = f.rootBoundary, o = f.altBoundary, B = f.flipVariations, E = B === void 0 ? !0 : B, y = f.allowedAutoPlacements, _ = u.options.placement, w = ru(_), v = w === _, A = r || (v || !E ? [hD(_)] : M2(_)), g = [_].concat(A).reduce(function(K, l) {
    ...
    }, []), h = u.rects.reference, k = u.rects.popper, S = /* @__PURE__ */ new Map(), O = !0, H = g[0], N = 0; N < g.length; N++) {
...
function V2(D) {
  var u = D.state, f = D.name, e = u.rects.reference, F = u.rects.popper, t = u.modifiersData.preventOverflow, n = uD(u, {
    ...
    altBoundary: !0
  }), r = vf(n, e), s = vf(a, F, t), d = Af(r), c = Af(s);
  u.modifiersData[f] = {
...
function Y2(D) {
  ...
  }, {}), a = n[u.placement], r = a.x, s = a.y;
  u.modifiersData.popperOffsets != null && (u.modifiersData.popperOffsets.x += r, u.modifiersData.popperOffsets.y += s), u.modifiersData[e] = n;
}
const X2 = {
  name: "offset",
  enabled: !0,
...
function J2(D) {
  var u = D.state, f = D.options, e = D.name, F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !1 : n, r = f.boundary, s = f.rootBoundary, d = f.altBoundary, c = f.padding, o = f.tether, B = o === void 0 ? !0 : o, E = f.tetherOffset, y = E === void 0 ? 0 : E, _ = uD(u, {
    boundary: r,
    rootBoundary: s,
    padding: c,
    altBoundary: d
  }), w = ru(u.placement), v = Ju(u.placement), A = !v, g = ef(w), h = Q2(g), k = u.modifiersData.popperOffsets, S = u.rects.reference, O = u.rects.popper, H = typeof y == "function" ? y(Object.assign({}, u.rects, {
    placement: u.placement
  })) : y, N = {
    x: 0,
    y: 0
  ...
  if (k) {
    if (t || a) {
      var U = g === "y" ? eu : tu, uu = g === "y" ? ou : su, G = g === "y" ? "height" : "width", nu = k[g], gu = k[g] + _[U], Eu = k[g] - _[uu], au = B ? -O[G] / 2 : 0, yu = v === Lu ? S[G] : O[G], W = v === Lu ? -O[G] : -S[G], X = u.elements.arrow, Q = B && X ? ff(X) : {
        width: 0,
        height: 0
      }, lu = u.modifiersData["arrow#persistent"] ? u.modifiersData["arrow#persistent"].padding : u1(), Bu = lu[U], K = lu[uu], l = mD(0, S[G], Q[G]), Ou = A ? S[G] / 2 - au - l - Bu - H : yu - l - Bu - H, Mu = A ? -S[G] / 2 + au + l + K + H : W + l + K + H, mu = u.elements.arrow && FD(u.elements.arrow), Hu = mu ? g === "y" ? mu.clientTop || 0 : mu.clientLeft || 0 : 0, aD = u.modifiersData.offset ? u.modifiersData.offset[u.placement][g] : 0, dD = k[g] + Ou - aD - Hu, rD = k[g] + Mu - aD;
      if (t) {
    ...
    var d = {
      ...
      setOptions: function(w) {
        ...
        if (d.orderedModifiers = v.filter(function(N) {
          ...
          var h = Cu(r), k = h.marginTop, S = h.marginRight, O = h.marginBottom, H = h.marginLeft;
          [k, S, O, H].some(function(N) {
            return parseFloat(N);
      ...
      forceUpdate: function() {
        if (!o) {
          ...
          for (var g = 0, h = 0; h < d.orderedModifiers.length; h++) {
            ...
            var k = d.orderedModifiers[h], S = k.fn, O = k.options, H = O === void 0 ? {} : O, N = k.name;
  ...
  return {
    ...
    methods: {
      ...
      $_addEventListeners: function() {
        var u = this, f = function(n, a, r, s, d) {
          var c = r;
  ...
  return p(), V(
    ...
    [L("div", x8, [L(
      ...
      [f.mounted ? (p(), V(
        ...
        [L("div", null, [x(D.$slots, "default")]), f.handleResize ? (p(), V(n, {
          key: 0,

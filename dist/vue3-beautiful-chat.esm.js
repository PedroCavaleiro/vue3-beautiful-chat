import { reactive as y1, openBlock as p, createElementBlock as m, normalizeStyle as R, createCommentVNode as I, renderSlot as O, createTextVNode as Nu, toDisplayString as Z, createElementVNode as g, resolveComponent as T, createVNode as q, withCtx as $, resolveDirective as w1, normalizeClass as DD, withDirectives as qf, createBlock as V, Fragment as qu, renderList as Ku, vShow as k1, withModifiers as Gu, pushScopeId as x1, popScopeId as S1, nextTick as T1, withScopeId as O1, withKeys as $1, mergeProps as Rf, createApp as j1, h as P1 } from "vue";
const Du = {
  state: y1({
    editMessage: null
  }),
...
const I1 = "data:image/svg+xml,%3c?xml%20version='1.0'%20encoding='iso-8859-1'?%3e%3csvg%20version='1.1'%20id='Capa_1'%20xmlns='http://www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%20x='0px'%20y='0px'%20viewBox='0%200%2047.971%2047.971'%20style='enable-background:new%200%200%2047.971%2047.971;'%20xml:space='preserve'%3e%3cg%3e%3crect%20x='0'%20y='20'%20width='47.971'%20height='7.971'%20rx='3'%20ry='3'/%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3cg%3e%3c/g%3e%3c/svg%3e", M = (D, u) => {
  ...
  computed: {
    ...Lf(["disableUserListToggle", "titleImageUrl", "showCloseButton", "showMinimizeButton"])
  },
  methods: {
    toggleUserList() {
...
function H1(D, u, f, e, F, t) {
  return p(), m("div", {
    ...
    D.disableUserListToggle ? (p(), m("div", q1, [
      O(D.$slots, "default", {}, () => [
        Nu(Z(f.title), 1)
      ], !0)
    ])) : (p(), m("div", {
    ...
    D.showMinimizeButton ? (p(), m("div", {
      ...
      f.icons.minimize.img ? (p(), m("img", {
        key: 0,
        src: f.icons.minimize.img,
        alt: f.icons.minimize.name
      }, null, 8, R1)) : (p(), m("svg", L1, u[3] || (u[3] = [
        g("g", null, [
          g("rect", {
            x: "0",
            y: "20",
...
const U1 = /* @__PURE__ */ M(z1, [["render", H1], ["__scopeId", "data-v-6211e2d6"]]), V1 = {
  props: {
    iconName: {
      type: String,
      default: "box"
...
const Hf = /* @__PURE__ */ M(u0, [["render", f0]]), df = (D) => D.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
function e0(D, ...u) {
  if (typeof D == "string")
    return df(D);
  let f = D[0];
...
function c0(D, u, f) {
  ...
  var t = function(v) {
    var A = {}, b = v, h = b.match(/^([a-z]+):\/\//i);
    return h && (A.scheme = h[1], b = b.substr(h[0].length)), h = b.match(/^(.*?)(?=(\?|#|\/|$))/i), h && (A.host = h[1], b = b.substr(h[0].length)), h = b.match(/^\/(.*?)(?=(\?|#|$))/i), h && (A.path = h[1], b = b.substr(h[0].length)), h = b.match(/^\?(.*?)(?=(#|$))/i), h && (A.query = h[1], b = b.substr(h[0].length)), h = b.match(/^#(.*?)$/i), h && (A.fragment = h[1]), A;
  }, n = function(v) {
    var A = "";
    return v.scheme && v.host && (A += v.scheme + "://"), v.host && (A += v.host), v.path && (A += "/" + v.path), v.query && (A += "?" + v.query), v.fragment && (A += "#" + v.fragment), A;
  }, a = function(v, A) {
    var b = A / 2, h = Math.ceil(b), k = -1 * Math.floor(b), x = "";
...
function of(D) {
  return Su.test(D) || m0.test(D) || Wf.test(D);
}
function PD(D) {
  return g0.test(D);
}
...
var R0 = /^mailto:/i, L0 = new RegExp("[".concat(Uf, "!#$%&'*+/=?^_`{|}~-]"));
function M0(D) {
  return Su.test(D);
}
function ID(D) {
...
function a3(D, u) {
  ...
  function g1(i, s) {
    i.acceptStateReached = !0, zD(s) ? i.state = 40 : s === "#" ? i.state = 41 : J.test(s) || (s === "(" ? i.state = 32 : cf(s) ? i.state = 39 : (L(i), Vu(s) && d.push(cD(
      c,
      0
      /* State.SchemeChar */
    ))));
...
function q3(D, u, f, e, F, t) {
  return p(), m("div", N3, Z(f.data.emoji), 1);
}
const R3 = /* @__PURE__ */ M(z3, [["render", q3], ["__scopeId", "data-v-ae11d5de"]]), L3 = {
  props: {
    messageColors: {
      type: Object,
      required: !0
...
const H3 = /* @__PURE__ */ M(L3, [["render", M3], ["__scopeId", "data-v-3df57161"]]), U3 = {
  props: {
    data: {
      type: Object,
      required: !0
...
8)`) {
        ...
        if (d.data[t][7] && (E.path = d.data[t][7], E.px = null, E.py = null, E.is_var = !1), E.is_var && d.include_text && r && r.actual && r.wrapper && (_ += r.wrapper + r.actual + r.wrapper), d.replace_mode == "css")
          if (d.use_sheet && E.px != null && E.py != null) {
            var w = 100 * E.px / (d.sheet_size - 1), v = 100 * E.py / (d.sheet_size - 1), A = 100 * d.sheet_size, b = "background: url(" + E.sheet + ");background-position:" + w + "% " + v + "%;background-size:" + A + "% " + A + "%";
            return '<span class="emoji-outer emoji-sizer"><span class="emoji-inner" style="' + b + '"' + y + ' data-codepoints="' + E.full_idx + '">' + _ + "</span></span>" + c;
  ...
  return p(), m("div", oe, [
    ...
    g("button", {
      ...
      (p(), m("svg", {
        ...
        g("g", null, [
          g("path", { d: `M18.696,37.393C8.387,37.393,0,29.006,0,18.696C0,8.387,8.387,0,18.696,0c10.31,0,18.696,8.387,18.696,18.696
        ...
        g("g", null, [
          g("path", { d: `M18.035,27.453c-5.748,0-8.342-4.18-8.449-4.357c-0.286-0.473-0.135-1.087,0.338-1.373
...
function Ye(D, u, f, e, F, t) {
  ...
  return p(), m("div", null, [
    ...
    g("form", {
      ...
      g("div", He, [
        u[6] || (u[6] = g("div", { class: "sc-user-input--button" }, null, -1)),
        f.showEmoji && !t.isEditing ? (p(), m("div", Ue, [
          q(a, {
        ...
        f.showFile && !t.isEditing ? (p(), m("div", Ve, [
          q(r, {
...
function i2(D, u, f, e, F, t) {
  ...
  return p(), m("div", null, [
    f.showLauncher ? (p(), m("div", {
      ...
      f.newMessagesCount > 0 && !f.isOpen ? (p(), m("div", a2, Z(f.newMessagesCount), 1)) : I("", !0),
      f.isOpen ? (p(), m("img", {
        key: 1,
...
var eu = "top", ou = "bottom", su = "right", tu = "left", AD = "auto", tD = [eu, ou, su, tu], Ru = "start", Df = "end", s2 = "clippingParents", Zf = "viewport", Wu = "popper", C2 = "reference", bf = /* @__PURE__ */ tD.reduce(function(D, u) {
...
function x2(D) {
  ...
  if (!(!t || !n)) {
    var c = k2(F.padding, f), o = ff(t), B = r === "y" ? eu : tu, E = r === "y" ? ou : su, y = f.rects.reference[d] + f.rects.reference[r] - n[r] - f.rects.popper[d], _ = n[r] - f.rects.reference[r], w = FD(t), v = w ? r === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, A = y / 2 - _ / 2, b = c[B], h = v - o[d] - c[E], k = v / 2 - o[d] / 2 + A, x = mD(b, k, h), S = r;
...
function mf(D) {
  var u, f = D.popper, e = D.popperRect, F = D.placement, t = D.offsets, n = D.position, a = D.gpuAcceleration, r = D.adaptive, C = D.roundOffsets, d = C === !0 ? $2(t) : typeof C == "function" ? C(t) : t, c = d.x, o = c === void 0 ? 0 : c, B = d.y, E = B === void 0 ? 0 : B, y = t.hasOwnProperty("x"), _ = t.hasOwnProperty("y"), w = tu, v = eu, A = window;
  if (r) {
    var b = FD(f), h = "clientHeight", k = "clientWidth";
    b === cu(f) && (b = Au(f), Cu(b).position !== "static" && (h = "scrollHeight", k = "scrollWidth")), b = b, F === eu && (v = ou, E -= b[h] - e.height, E *= a ? 1 : -1), F === tu && (w = su, o -= b[k] - e.width, o *= a ? 1 : -1);
  }
  var x = Object.assign({
    position: n
  }, r && O2);
...
function _f(D, u) {
  return u === Zf ? VD(R2(D)) : Fu(u) ? M2(u) : VD(L2(Au(D)));
}
function H2(D) {
...
function G2(D) {
  ...
  if (!u.modifiersData[e]._skip) {
    for (var F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !0 : n, r = f.fallbackPlacements, C = f.padding, d = f.boundary, c = f.rootBoundary, o = f.altBoundary, B = f.flipVariations, E = B === void 0 ? !0 : B, y = f.allowedAutoPlacements, _ = u.options.placement, w = ru(_), v = w === _, A = r || (v || !E ? [hD(_)] : W2(_)), b = [_].concat(A).reduce(function(K, l) {
    ...
    }, []), h = u.rects.reference, k = u.rects.popper, x = /* @__PURE__ */ new Map(), S = !0, H = b[0], z = 0; z < b.length; z++) {
...
function e8(D) {
  var u = D.state, f = D.options, e = D.name, F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !1 : n, r = f.boundary, C = f.rootBoundary, d = f.altBoundary, c = f.padding, o = f.tether, B = o === void 0 ? !0 : o, E = f.tetherOffset, y = E === void 0 ? 0 : E, _ = uD(u, {
    ...
    padding: c,
    altBoundary: d
  }), w = ru(u.placement), v = Ju(u.placement), A = !v, b = ef(w), h = f8(b), k = u.modifiersData.popperOffsets, x = u.rects.reference, S = u.rects.popper, H = typeof y == "function" ? y(Object.assign({}, u.rects, {
    placement: u.placement
  })) : y, z = {
    x: 0,
    y: 0
  ...
  if (k) {
    if (t || a) {
      var U = b === "y" ? eu : tu, uu = b === "y" ? ou : su, G = b === "y" ? "height" : "width", nu = k[b], gu = k[b] + _[U], Eu = k[b] - _[uu], au = B ? -S[G] / 2 : 0, yu = v === Ru ? x[G] : S[G], W = v === Ru ? -S[G] : -x[G], X = u.elements.arrow, Q = B && X ? ff(X) : {
        width: 0,
        height: 0
      ...
      if (a) {
        var SD = b === "x" ? eu : tu, TD = b === "x" ? ou : su, $u = k[h], oD = $u + _[SD], sD = $u - _[TD], CD = mD(B ? Qu(oD, dD) : oD, $u, B ? vu(sD, rD) : sD);
        k[h] = CD, z[h] = CD - $u;
      }
    }
    u.modifiersData[e] = z;
  ...
  return function(a, r, C) {
    ...
    var d = {
      ...
      setOptions: function(w) {
        ...
        var v = r8(E8([].concat(e, d.options.modifiers)));
        if (d.orderedModifiers = v.filter(function(z) {
          return z.enabled;
        }), process.env.NODE_ENV !== "production") {
          var A = c8([].concat(v, d.options.modifiers), function(z) {
            var U = z.name;
            return U;
          });
          if (C8(A), ru(d.options.placement) === AD) {
      ...
      forceUpdate: function() {
        if (!o) {
          ...
          d.rects = {
            reference: a8(v, FD(A), d.options.strategy === "fixed"),
            popper: ff(A)
          ...
          for (var b = 0, h = 0; h < d.orderedModifiers.length; h++) {
            ...
            var k = d.orderedModifiers[h], x = k.fn, S = k.options, H = S === void 0 ? {} : S, z = k.name;
    ...
    function E() {
      d.orderedModifiers.forEach(function(_) {
        var w = _.name, v = _.options, A = v === void 0 ? {} : v, b = _.effect;

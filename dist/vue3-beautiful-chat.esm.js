import { reactive as y1, openBlock as p, createElementBlock as g, normalizeStyle as R, createCommentVNode as I, renderSlot as O, createTextVNode as qu, toDisplayString as Z, Fragment as Ou, createElementVNode as y, resolveComponent as T, createVNode as q, withCtx as $, resolveDirective as w1, normalizeClass as DD, withDirectives as qf, createBlock as V, renderList as Ku, vShow as k1, withModifiers as Gu, pushScopeId as x1, popScopeId as S1, nextTick as T1, withScopeId as O1, withKeys as $1, mergeProps as Rf, createApp as j1, h as P1 } from "vue";
const Du = {
  state: y1({
    editMessage: null
  }),
...
const H1 = /* @__PURE__ */ M(z1, [["render", M1], ["__scopeId", "data-v-41e4bfdf"]]), U1 = {
  props: {
    iconName: {
      type: String,
      default: "box"
...
const Hf = /* @__PURE__ */ M(U1, [["render", Y1], ["__scopeId", "data-v-1fd45a6c"]]), X1 = {}, K1 = { d: "M19.404,6.65l-5.998-5.996c-0.292-0.292-0.765-0.292-1.056,0l-2.22,2.22l-8.311,8.313l-0.003,0.001v0.003l-0.161,0.161c-0.114,0.112-0.187,0.258-0.21,0.417l-1.059,7.051c-0.035,0.233,0.044,0.47,0.21,0.639c0.143,0.14,0.333,0.219,0.528,0.219c0.038,0,0.073-0.003,0.111-0.009l7.054-1.055c0.158-0.025,0.306-0.098,0.417-0.211l8.478-8.476l2.22-2.22C19.695,7.414,19.695,6.941,19.404,6.65z M8.341,16.656l-0.989-0.99l7.258-7.258l0.989,0.99L8.341,16.656z M2.332,15.919l0.411-2.748l4.143,4.143l-2.748,0.41L2.332,15.919z M13.554,7.351L6.296,14.61l-0.849-0.848l7.259-7.258l0.423,0.424L13.554,7.351zM10.658,4.457l0.992,0.99l-7.259,7.258L3.4,11.715L10.658,4.457z M16.656,8.342l-1.517-1.517V6.823h-0.003l-0.951-0.951l-2.471-2.471l1.164-1.164l4.942,4.94L16.656,8.342z" };
function Z1(D, u) {
  return p(), g("path", K1);
}
...
const Uf = /* @__PURE__ */ M(J1, [["render", D0]]), df = (D) => D.replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
function f0(D, ...u) {
  if (typeof D == "string")
    return df(D);
  let f = D[0];
...
function y0(D) {
  ...
  if (!u)
    return !1;
  var f = !!u[1], e = u[2];
  return f ? !0 : !(e.indexOf(".") === -1 || !Nu.test(e));
}
function w0(D) {
  var u = D.match(A0);
  if (!u)
  ...
  function(D) {
    ...
    return u.prototype.getType = function() {
      ...
      switch (f) {
        ...
        default:
          throw zu(f), new Error("Invalid hashtag service: ".concat(f));
      }
    }, u.prototype.getAnchorText = function() {
      return "#" + this.hashtag;
  ...
  function(D) {
    ...
    return u.prototype.getType = function() {
      ...
      switch (this.serviceName) {
        ...
        default:
          throw zu(this.serviceName), new Error("Unknown service name to point mention to: " + this.serviceName);
      }
    }, u.prototype.getAnchorText = function() {
      return "@" + this.mention;
    }, u.prototype.getCssClassSuffixes = function() {
...
function d3(D) {
  for (var u = {
    ...
    var e = D.charAt(f);
    a3.test(e) ? u[e]++ : Ef.test(e) && u[lf[e]]--;
  }
...
function c3(D, u) {
  ...
  function A(l) {
    l === "!" ? d = 13 : l === "/" ? (d = 2, o = new pu(Y(Y({}, o), { isClosing: !0 }))) : l === "<" ? X() : Nu.test(l) ? (d = 3, o = new pu(Y(Y({}, o), { isOpening: !0 }))) : (d = 0, o = a);
  }
  function h(l) {
    du.test(l) ? (o = new pu(Y(Y({}, o), { name: Bu() })), d = 4) : l === "<" ? X() : l === "/" ? (o = new pu(Y(Y({}, o), { name: Bu() })), d = 12) : l === ">" ? (o = new pu(Y(Y({}, o), { name: Bu() })), Q()) : !Nu.test(l) && !J.test(l) && l !== ":" && W();
  }
  function w(l) {
    l === ">" ? W() : Nu.test(l) ? d = 3 : W();
  }
...
function Q3(D, u, f, e, F, t) {
  ...
  return p(), g("div", {
    ...
    (p(!0), g(Ou, null, Ku(f.messages, (a, r) => (p(), V(n, {
      key: a.id ? a.id : r,
      message: a,
...
function ae(D, u, f, e, F, t) {
  return p(), g("div", {
    ...
    y("div", Fe, [
      (p(!0), g(Ou, null, Ku(F.emojiData, (n) => (p(), g("div", {
        key: n.name,
        ...
        (p(!0), g(Ou, null, Ku(n.emojis, (a) => (p(), g("span", {
          key: a,
...
function ye(D, u, f, e, F, t) {
  return p(), g("div", {
    ...
    (p(!0), g(Ou, null, Ku(f.suggestions, (n, a) => (p(), g("button", {
      key: a,
...
function Je(D, u, f, e, F, t) {
  return p(), g("div", {
    ...
    y("table", Ke, [
      y("tbody", null, [
        (p(!0), g(Ou, null, Ku(f.participants, (n) => (p(), g("tr", {
          key: n.id
        }, [
          y("td", Ze, [
            y("img", {
...
const i2 = /* @__PURE__ */ M(F2, [["render", r2], ["__scopeId", "data-v-4be0cafc"]]);
var eu = "top", ou = "bottom", su = "right", tu = "left", AD = "auto", tD = [eu, ou, su, tu], Ru = "start", Df = "end", o2 = "clippingParents", Zf = "viewport", Wu = "popper", s2 = "reference", bf = /* @__PURE__ */ tD.reduce(function(D, u) {
...
function k2(D) {
  ...
  if (!(!t || !n)) {
    var c = w2(F.padding, f), o = ff(t), B = r === "y" ? eu : tu, E = r === "y" ? ou : su, A = f.rects.reference[d] + f.rects.reference[r] - n[r] - f.rects.popper[d], h = n[r] - f.rects.reference[r], w = FD(t), _ = w ? r === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, v = A / 2 - h / 2, b = c[B], m = _ - o[d] - c[E], k = _ / 2 - o[d] / 2 + v, x = mD(b, k, m), S = r;
...
function _f(D, u) {
  return u === Zf ? VD(q2(D)) : Fu(u) ? L2(u) : VD(R2(Au(D)));
}
function M2(D) {
...
function f8(D) {
  var u = D.state, f = D.options, e = D.name, F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !1 : n, r = f.boundary, C = f.rootBoundary, d = f.altBoundary, c = f.padding, o = f.tether, B = o === void 0 ? !0 : o, E = f.tetherOffset, A = E === void 0 ? 0 : E, h = uD(u, {
    ...
    padding: c,
    altBoundary: d
  }), w = ru(u.placement), _ = Ju(u.placement), v = !_, b = ef(w), m = D8(b), k = u.modifiersData.popperOffsets, x = u.rects.reference, S = u.rects.popper, H = typeof A == "function" ? A(Object.assign({}, u.rects, {
    placement: u.placement
  })) : A, z = {
    x: 0,
    y: 0
  ...
  if (k) {
    if (t || a) {
      var U = b === "y" ? eu : tu, uu = b === "y" ? ou : su, G = b === "y" ? "height" : "width", nu = k[b], gu = k[b] + h[U], Eu = k[b] - h[uu], au = B ? -S[G] / 2 : 0, yu = _ === Ru ? x[G] : S[G], W = _ === Ru ? -S[G] : -x[G], X = u.elements.arrow, Q = B && X ? ff(X) : {
        width: 0,
        height: 0
      }, lu = u.modifiersData["arrow#persistent"] ? u.modifiersData["arrow#persistent"].padding : u1(), Bu = lu[U], K = lu[uu], l = mD(0, x[G], Q[G]), $u = v ? x[G] / 2 - au - l - Bu - H : yu - l - Bu - H, Mu = v ? -x[G] / 2 + au + l + K + H : W + l + K + H, mu = u.elements.arrow && FD(u.elements.arrow), Hu = mu ? b === "y" ? mu.clientTop || 0 : mu.clientLeft || 0 : 0, aD = u.modifiersData.offset ? u.modifiersData.offset[u.placement][b] : 0, dD = k[b] + $u - aD - Hu, rD = k[b] + Mu - aD;
      if (t) {
        var iD = mD(B ? Qu(gu, dD) : gu, nu, B ? vu(Eu, rD) : Eu);
        k[b] = iD, z[b] = iD - nu;
      }
      if (a) {
        var SD = b === "x" ? eu : tu, TD = b === "x" ? ou : su, ju = k[m], oD = ju + h[SD], sD = ju - h[TD], CD = mD(B ? Qu(oD, dD) : oD, ju, B ? vu(sD, rD) : sD);
        k[m] = CD, z[m] = CD - ju;
      }
    }
    u.modifiersData[e] = z;
...
const g8 = /* @__PURE__ */ O1("data-v-b329ee4c");
x1("data-v-b329ee4c");
const m8 = {
  ...
  return {
    ...
    methods: {
      ...
      $_scheduleShow: function() {
        ...
        if (this.$_hideInProgress = !1, clearTimeout(this.$_scheduleTimer), Pu && this.instantMove && Pu.instantMove) {
          Pu.$_applyHide(!0), this.$_applyShow(!0);
          return;
        }
      ...
      $_scheduleHide: function() {
        var u = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
        this.$_hideInProgress = !0, clearTimeout(this.$_scheduleTimer), this.isShown && (Pu = this), u ? this.$_applyHide() : this.$_scheduleTimer = setTimeout(this.$_applyHide.bind(this), this.$_computeDelay("hide"));
      },
      ...
      $_applyShowEffect: function() {
        ...
        return xu(function* () {
          if (!u.$_hideInProgress) {
            ...
            Iu.push(u), u.$emit("apply-show"), u.$_popperNode.setAttribute("data-popper-placement", u.popperInstance.state.placement), u.classes.showFrom = !0, u.classes.showTo = !1, u.classes.hideFrom = !1, u.classes.hideTo = !1, yield $f(), u.classes.showFrom = !1, u.classes.showTo = !0;
          }
        })();
      },
      $_applyHide: function() {
        ...
        return xu(function* () {
          ...
          if (clearTimeout(f.$_scheduleTimer), !!f.isShown) {
            f.skipTransition = e, x8(Iu, f), Pu === f && (Pu = null), f.isShown = !1, f.popperInstance && (yield f.$_refreshPopperOptions()), f.$_applyAttrsToTarget({
...
typeof document < "u" && typeof window < "u" && (d1 ? document.addEventListener("touchend", T8, vD ? {
  passive: !0,
  capture: !0
...
function i1(D) {
  for (var u = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1, f = function(t) {
    var n = Iu[t], a = n.popperNode(), r = a.contains(D.target);
...
function JD(D) {
  ...
  JD.installed || (JD.installed = !0, a1(Tu, u), D.directive("tooltip", L8), D.directive("close-popper", M8), D.component("v-tooltip", QD), D.component("VTooltip", QD), D.component("v-dropdown", KD), D.component("VDropdown", KD), D.component("v-menu", ZD), D.component("VMenu", ZD));
}
var H8 = {

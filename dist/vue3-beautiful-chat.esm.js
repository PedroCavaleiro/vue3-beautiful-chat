import { reactive as A1, openBlock as b, createElementBlock as m, normalizeStyle as S, createCommentVNode as q, renderSlot as j, createTextVNode as Nu, toDisplayString as K, createElementVNode as y, resolveComponent as O, createVNode as R, withCtx as $, resolveDirective as y1, normalizeClass as DD, withDirectives as Rf, createBlock as V, Fragment as Ru, renderList as Qu, vShow as w1, withModifiers as Gu, pushScopeId as k1, popScopeId as x1, nextTick as S1, withScopeId as T1, withKeys as O1, mergeProps as qf, createApp as j1, h as $1 } from "vue";
const Du = {
  state: A1({
    editMessage: null
  }),
...
function y3(D, u, f, e, F, t) {
  ...
  return b(), m("div", {
    ...
    y("div", {
      ...
      j(D.$slots, "text-message-toolbox", {
        message: f.message,
        me: t.me
      }, void 0, !0)
    ], 4),
...
function M3(D, u, f, e, F, t) {
  return b(), m("div", {
    ...
    j(D.$slots, "default", { message: f.data }, () => [
      Nu(K(f.data.text) + " ", 1),
      f.data.meta ? (b(), m("p", {
        key: 0,
        class: "sc-message--meta",
...
const oe = /* @__PURE__ */ M(de, [["render", ie], ["__scopeId", "data-v-cd59fe4c"]]), se = {
  props: {
    onChange: {
      type: Function,
      required: !0
  ...
  return b(), m("div", Ce, [
    y("button", {
      ...
      (b(), m("svg", {
        ...
        viewBox: "0 0 37.393 37.393",
        enableBackground: "new 0 0 37.393 37.393",
        style: S({ fill: f.color, marginTop: "8px" })
      }, [
        y("path", {
          style: S({ fill: f.color }),
...
const Ee = /* @__PURE__ */ M(se, [["render", ce], ["__scopeId", "data-v-a41d0870"]]), le = {
  components: {
    IconBase: Mf
  },
  props: {
...
const pe = /* @__PURE__ */ M(le, [["render", be], ["__scopeId", "data-v-3ee3b811"]]), ge = {
  props: {
    suggestions: {
      type: Array,
      default: () => []
...
const je = /* @__PURE__ */ M(Se, [["render", Oe]]), $e = {
  components: {
    EmojiIcon: oe,
    FileIcons: Ee,
    UserInputButton: pe,
...
}, Pe = { class: "icon-file-message" }, Ie = ["src", "alt"], ze = ["src", "alt"], Ne = ["placeholder"], Re = { class: "sc-user-input--buttons" }, qe = {
  key: 0,
...
const Ve = /* @__PURE__ */ M($e, [["render", Ue]]), We = {
  props: {
    participants: {
      type: Array,
      required: !0
...
}, Ge = { style: { "padding-top": "5px" } }, Xe = { style: { "text-align": "center" } }, Ye = ["src"];
...
const Ke = /* @__PURE__ */ M(We, [["render", Qe], ["__scopeId", "data-v-4899c8d9"]]), Je = {
  components: {
    Header: L1,
    MessageList: K3,
    UserInput: Ve,
...
function a2(D, u, f, e, F, t) {
  ...
  return b(), m("div", null, [
    f.showLauncher ? (b(), m("div", {
      ...
      f.newMessagesCount > 0 && !f.isOpen ? (b(), m("div", t2, K(f.newMessagesCount), 1)) : q("", !0),
      f.isOpen ? (b(), m("img", {
        key: 1,
...
const d2 = /* @__PURE__ */ M(e2, [["render", a2], ["__scopeId", "data-v-67e1ae28"]]);
var eu = "top", ou = "bottom", su = "right", tu = "left", AD = "auto", tD = [eu, ou, su, tu], qu = "start", Df = "end", r2 = "clippingParents", Qf = "viewport", Wu = "popper", i2 = "reference", pf = /* @__PURE__ */ tD.reduce(function(D, u) {
  return D.concat([u + "-" + qu, u + "-" + Df]);
}, []), yD = /* @__PURE__ */ [].concat(tD, [AD]).reduce(function(D, u) {
  return D.concat([u, u + "-" + qu, u + "-" + Df]);
}, []), o2 = "beforeRead", s2 = "read", C2 = "afterRead", c2 = "beforeMain", E2 = "main", l2 = "afterMain", B2 = "beforeWrite", b2 = "write", p2 = "afterWrite", UD = [o2, s2, C2, c2, E2, l2, B2, b2, p2];
function pu(D) {
...
function y2(D) {
  ...
  if (!(!t || !n)) {
    var c = A2(F.padding, f), o = ff(t), B = r === "y" ? eu : tu, E = r === "y" ? ou : su, A = f.rects.reference[d] + f.rects.reference[r] - n[r] - f.rects.popper[d], h = n[r] - f.rects.reference[r], w = FD(t), _ = w ? r === "y" ? w.clientHeight || 0 : w.clientWidth || 0 : 0, v = A / 2 - h / 2, p = c[B], g = _ - o[d] - c[E], k = _ / 2 - o[d] / 2 + v, x = mD(p, k, g), T = r;
...
function mf(D) {
  var u, f = D.popper, e = D.popperRect, F = D.placement, t = D.offsets, n = D.position, a = D.gpuAcceleration, r = D.adaptive, C = D.roundOffsets, d = C === !0 ? S2(t) : typeof C == "function" ? C(t) : t, c = d.x, o = c === void 0 ? 0 : c, B = d.y, E = B === void 0 ? 0 : B, A = t.hasOwnProperty("x"), h = t.hasOwnProperty("y"), w = tu, _ = eu, v = window;
  if (r) {
...
function _f(D, u) {
  return u === Qf ? VD(z2(D)) : Fu(u) ? R2(u) : VD(N2(Au(D)));
}
function q2(D) {
...
function U2(D) {
  ...
  if (!u.modifiersData[e]._skip) {
    for (var F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !0 : n, r = f.fallbackPlacements, C = f.padding, d = f.boundary, c = f.rootBoundary, o = f.altBoundary, B = f.flipVariations, E = B === void 0 ? !0 : B, A = f.allowedAutoPlacements, h = u.options.placement, w = ru(h), _ = w === h, v = r || (_ || !E ? [hD(h)] : H2(h)), p = [h].concat(v).reduce(function(Q, l) {
      return Q.concat(ru(l) === AD ? M2(u, {
        placement: l,
        boundary: d,
        rootBoundary: c,
        padding: C,
...
function u8(D) {
  var u = D.state, f = D.options, e = D.name, F = f.mainAxis, t = F === void 0 ? !0 : F, n = f.altAxis, a = n === void 0 ? !1 : n, r = f.boundary, C = f.rootBoundary, d = f.altBoundary, c = f.padding, o = f.tether, B = o === void 0 ? !0 : o, E = f.tetherOffset, A = E === void 0 ? 0 : E, h = uD(u, {
    ...
    padding: c,
    altBoundary: d
  }), w = ru(u.placement), _ = Zu(u.placement), v = !_, p = ef(w), g = Z2(p), k = u.modifiersData.popperOffsets, x = u.rects.reference, T = u.rects.popper, H = typeof A == "function" ? A(Object.assign({}, u.rects, {
    placement: u.placement
  })) : A, z = {
    x: 0,
    y: 0
...
function t8(D, u, f) {
  ...
  nf(e)) && (n = e8(u)), Fu(u) ? (a = Lu(u), a.x += u.clientLeft, a.y += u.clientTop) : e && (a.x = Ff(e))), {
  ...
  return function(a, r, C) {
    ...
    var d = {
      ...
      setOptions: function(w) {
        ...
        var _ = n8(s8([].concat(e, d.options.modifiers)));
        if (d.orderedModifiers = _.filter(function(z) {
          return z.enabled;
        }), process.env.NODE_ENV !== "production") {
          var v = o8([].concat(_, d.options.modifiers), function(z) {
            var U = z.name;
            return U;
          });
          if (i8(v), ru(d.options.placement) === AD) {
      ...
      forceUpdate: function() {
        if (!o) {
          ...
          d.rects = {
            reference: t8(_, FD(v), d.options.strategy === "fixed"),
            popper: ff(v)
...
var E8 = [$2, J2, O2, h2, Q2, V2, D8, k2, G2], l8 = /* @__PURE__ */ c8({
  defaultModifiers: E8
});
function B8() {
...
const b8 = /* @__PURE__ */ T1("data-v-b329ee4c");
k1("data-v-b329ee4c");
const p8 = {
      ...
      $_applyHide: function() {
        ...
        return xu(function* () {
          ...
          if (clearTimeout(f.$_scheduleTimer), !!f.isShown) {
            f.skipTransition = e, w8(Pu, f), $u === f && ($u = null), f.isShown = !1, f.popperInstance && (yield f.$_refreshPopperOptions()), f.$_applyAttrsToTarget({
...
typeof document < "u" && typeof window < "u" && (a1 ? document.addEventListener("touchend", x8, vD ? {
  passive: !0,
  capture: !0
  ...
  return b(), V(
    ...
    [R("div", S8, [R(
      ...
      [f.mounted ? (b(), V(
        ...
        [R("div", null, [j(D.$slots, "default")]), f.handleResize ? (b(), V(n, {
          key: 0,
...
function ZD(D) {
  ...
  ZD.installed || (ZD.installed = !0, n1(Tu, u), D.directive("tooltip", R8), D.directive("close-popper", q8), D.component("v-tooltip", JD), D.component("VTooltip", JD), D.component("v-dropdown", QD), D.component("VDropdown", QD), D.component("v-menu", KD), D.component("VMenu", KD));
}
var L8 = {
...
const gD = /* @__PURE__ */ uf(U8), V8 = {
  ...
  install(D, u = {}) {
    this.installed || D.prototype && D.prototype.$isServer || (this.installed = !0, D.config.globalProperties.$event = V8, this.componentName = u.componentName || W8, D.component(this.componentName, d2), D.use(L8));
  }
};
export {
  X8 as default
